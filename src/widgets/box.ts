 ...
 */
function calculateContentWidth(lines: string[]): number {
...
function buildBorderLine(
  ...
  if (!label) {
    ...
    return (
      styleText(leftCorner, borderStyle) +
      styledLine +
...
class BoxWidget implements Widget {
  ...
  constructor(private options: BoxOptions) {}
  ...
  render(ctx: RenderContext): string[] {
    ...
    const contentCtx: RenderContext = {
 ...
 */
export function Box(
  optionsOrContent: BoxOptions | string | Widget | (string | Widget)[],
): Widget {
  if (
...
export function Panel(
  title: string,
  content: string | Widget | (string | Widget)[],
  options?: Partial<Omit<BoxOptions, "title" | "content">>,
): Widget {
