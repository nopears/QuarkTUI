...
import type { Widget, RenderContext, RowOptions, Alignment } from "./types";
 ...
 */
function alignRow(row: string, width: number, alignment: Alignment): string {
...
class RowWidget implements Widget {
  ...
  render(ctx: RenderContext): string[] {
    ...
    const childCtx: RenderContext = { ...ctx, innerWidth: 0 };
 ...
 * ])
 */
export function Row(items: Widget[], options?: RowOptions): Widget {
