...
// Rendering
// =============================================================================
function buildHelpLines(content) {
 ...
 * ```
 */
export async function showHelp(content) {
 ...
 * ```
 */
export function mergeHelpContent(...contents) {
 ...
 * ```
 */
export function createSimpleHelp(screenName, bindings) {
    return {
        screenName,
        description: "",
        sections: [
